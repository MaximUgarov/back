...
class Assets
{
    ...
    public function enqueue_block_editor_assets()
    {
        ...
        $this->enqueueScript(RML_SLUG . '-gutenberg', [[$this->isPro(), 'rml_gutenberg.pro.js'], 'rml_gutenberg.lite.js'], ['wp-blocks', 'wp-i18n', 'wp-element', 'es6-shim', 'es7-shim']);
    }
    /**
    ...
    public function plugin_row_meta($links, $file)
    {
        if (\false !== \strpos($file, plugin_basename(RML_FILE))) {
            $links[] = '<a target="_blank" href="https://devowl.io/wordpress-real-media-library/#complementary-plugins"><strong>' . __('Complementary Plugins', RML_TD) . '</strong></a>';
        }
        return $links;
    }
    /**
