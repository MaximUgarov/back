 ...
 */
class Core extends \MatthiasWeb\RealMediaLibrary\base\Core implements \MatthiasWeb\RealMediaLibrary\overrides\interfce\IOverrideCore
{
    use LiteCore;
    /**
     * Singleton instance.
    ...
    protected function __construct()
    {
        ...
        \MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\ServiceNoStore::hook('/' . \MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\Service::getNamespace($this));
        \MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\ServiceNoStore::hook('/' . \MatthiasWeb\RealMediaLibrary\rest\Service::LEGACY_NAMESPACE);
        // Register creatables
        ...
        add_filter('RML/Validate/Insert', [\MatthiasWeb\RealMediaLibrary\attachment\Permissions::getInstance(), 'insert'], 10, 3);
        add_filter('RML/Validate/Create', [\MatthiasWeb\RealMediaLibrary\attachment\Permissions::getInstance(), 'create'], 10, 4);
        add_filter('RML/Validate/Rename', [\MatthiasWeb\RealMediaLibrary\attachment\Permissions::getInstance(), 'setName'], 10, 3);
        add_filter('RML/Validate/Delete', [\MatthiasWeb\RealMediaLibrary\attachment\Permissions::getInstance(), 'deleteFolder'], 10, 3);
    ...
    public function init()
    {
        ...
        add_action('add_attachment', [\MatthiasWeb\RealMediaLibrary\attachment\Upload::getInstance(), 'add_attachment']);
        add_action('wp_prepare_attachment_for_js', [\MatthiasWeb\RealMediaLibrary\attachment\Filter::getInstance(), 'wp_prepare_attachment_for_js'], 10, 3);
        add_action('RML/Options/Register', [\MatthiasWeb\RealMediaLibrary\comp\ExImport::getInstance(), 'options_register']);
        add_action('RML/Folder/Deleted', [\MatthiasWeb\RealMediaLibrary\metadata\Meta::getInstance(), 'folder_deleted'], 10, 2);
        add_action('RML/Scripts', [\MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealUtils\Core::getInstance()->getAssets(), 'admin_enqueue_scripts']);
        add_filter('posts_clauses', [\MatthiasWeb\RealMediaLibrary\attachment\Filter::getInstance(), 'posts_clauses'], 10, 2);
        ...
        add_filter('add_post_metadata', [\MatthiasWeb\RealMediaLibrary\attachment\Shortcut::getInstance(), 'add_post_metadata'], 999999, 5);
        add_filter('update_post_metadata', [\MatthiasWeb\RealMediaLibrary\attachment\Shortcut::getInstance(), 'update_post_metadata'], 999999, 5);
        add_filter('get_post_metadata', [\MatthiasWeb\RealMediaLibrary\attachment\Shortcut::getInstance(), 'get_post_metadata'], 999999, 4);
        add_filter('attachment_fields_to_edit', [\MatthiasWeb\RealMediaLibrary\attachment\CustomField::getInstance(), 'attachment_fields_to_edit'], 10, 2);
        add_filter('attachment_fields_to_save', [\MatthiasWeb\RealMediaLibrary\attachment\CustomField::getInstance(), 'attachment_fields_to_save'], 10, 2);
        add_filter('restrict_manage_posts', [\MatthiasWeb\RealMediaLibrary\attachment\Filter::getInstance(), 'restrict_manage_posts']);
        add_filter('ajax_query_attachments_args', [\MatthiasWeb\RealMediaLibrary\attachment\Filter::getInstance(), 'ajax_query_attachments_args']);
        add_filter('mla_media_modal_query_final_terms', [\MatthiasWeb\RealMediaLibrary\attachment\Filter::getInstance(), 'ajax_query_attachments_args']);
        add_filter('shortcode_atts_gallery', [\MatthiasWeb\RealMediaLibrary\view\FolderShortcode::getInstance(), 'shortcode_atts_gallery'], 1, 3);
        ...
        add_rml_user_settings_box('allFilesShortcuts', new \MatthiasWeb\RealMediaLibrary\usersettings\AllFilesShortcuts(), \false, 0);
        add_rml_user_settings_box('defaultFolder', new \MatthiasWeb\RealMediaLibrary\usersettings\DefaultFolder(), \false, 0);
