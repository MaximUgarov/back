...
class Core
{
    ...
    private function __construct()
    {
        ...
        $this->crossSellingHandler = \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealUtils\cross\CrossSellingHandler::instance($this);
        ...
        add_action('rest_api_init', [\MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealUtils\Service::instance(), 'rest_api_init']);
        ...
        $this->crossSelling[\MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner::SLUG] = new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealUtils\cross\CrossRealCookieBanner();
    ...
    {
        return !isset(self::$me) ? self::$me = new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealUtils\Core() : self::$me;
    }
}
