...
trait Activator
{
    ...
    public function install($errorlevel = \false, $installThisCallable = null)
    {
        ...
        if ($installThisCallable === null) {
            update_option($this->getPluginConstant(\MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_OPT_PREFIX) . '_db_version', $this->getPluginConstant(\MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_VERSION));
        }
    }
}
