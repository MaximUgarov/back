...
trait CoreLite
{
    ...
    public function isLiteNoticeDismissed($set = null)
    {
        ...
        $base = $this;
        $value = '1';
        $expireOption = new \MatthiasWeb\RealMediaLibrary\Vendor\MatthiasWeb\Utils\ExpireOption($base->getPluginConstant('OPT_PREFIX') . '_liteDismissed', \false, 20 * \constant('DAY_IN_SECONDS'));
